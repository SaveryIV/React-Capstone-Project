...
# 🕹️ React Capstone Project! <a name="about-project"></a>

This project is dedicated to crafting a webapp using REACT.js, Redux to save in a local store information extracted from a Marvel API.
...
The actual designer is [Nelson Sakwa](https://www.behance.net/sakwadesignstudio).
